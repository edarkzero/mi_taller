...
$(document).ready(function (e)
{
    ...
    $(document).on('click','area',function(e)
    {
        ...
        if(!isSelectedElem) {
            ...
            $('#carpart-size_id').val($elem.attr('data-tabulator')).trigger('change');
        }

        else
        {
            storeChanges(1,false);
        }
    });
...
function storeChanges(mode,all)
{
    var q = null;
